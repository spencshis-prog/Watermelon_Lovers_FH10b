...
def apply_noise_reduction(input_dir, output_base_dir):
    ...
    techniques = {  # as assessed by qilin set
        ...
        "spectral_sub_naive": nr_spectral_subtraction_naive,  # mid performance
        # "db1_wavelet": nr_db1_wavelet  # poor performance
        "spectral_sub_dynamic": nr_spectral_subtraction_dynamic,  # untested
        "wiener": nr_wiener,  # untested
        "steg": nr_short_time_energy_gating,  # untested
        "db8_dwt": nr_db8_wavelet_advanced,  # untested
    }
