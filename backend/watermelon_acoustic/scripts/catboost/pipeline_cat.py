import os
import functions
from scripts.catboost.cat_optuna import kfold_train_feature_set_cat_optuna
# Import the CatBoost training and testing functions from your CatBoost modules.
from scripts.catboost.cat_training import kfold_train_all_feature_models_cat
from scripts.catboost.cat_testing import test_all_cat_models
...
def proceed(TRAIN_NEW_MODELS=False):
    ...
    if TRAIN_NEW_MODELS:
        ...
        for ht in sorted(HT_OPTIONS):
            ...
            if ht == "optuna":
                kfold_train_feature_set_cat_optuna(
