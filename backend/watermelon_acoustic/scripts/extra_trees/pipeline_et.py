import os
import functions
from scripts.extra_trees.et_optuna import kfold_train_feature_set_et_optuna
from scripts.extra_trees.et_training import kfold_train_all_feature_models_et
from scripts.extra_trees.et_testing import test_all_et_models
...
def proceed(TRAIN_NEW_MODELS=False):
    ...
    if TRAIN_NEW_MODELS:
        ...
        for ht in sorted(HT_OPTIONS):
            ...
            if ht == "optuna":
                kfold_train_feature_set_et_optuna(
